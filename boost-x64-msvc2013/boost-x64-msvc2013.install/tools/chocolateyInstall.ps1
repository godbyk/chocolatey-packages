...
$packageName = 'boost-x64-msvc2013.install' # arbitrary name for the package, used in messages
$installerType = 'exe'
...
$url = 'http://superb-dca3.dl.sourceforge.net/project/boost/boost-binaries/1.57.0/boost_1_57_0-msvc-12.0-64.exe'
